...
$DeluxeShop = New-Object System.Windows.Forms.Label -Property @{
    AutoSize = $true
...
@($DeluxeShop, $malwru, $lolzteam, $github, $questions, $telegram, $lolzteam2, $github2) | ForEach-Object { $InfoTab.Controls.Add($_) }
